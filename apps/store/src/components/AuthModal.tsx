    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl overflow-hidden slide-up">
        ...
        <div className="relative bg-gradient-to-br from-primary to-primary-dark p-6 text-white">
          ...
          <p className="text-primary-pale/80 text-sm">
        ...
        <div className="p-6 space-y-4">
          {mode === 'register' && (
            <div className="relative">
              ...
              <input value={form.name} onChange={set('name')} placeholder="Tu nombre completo"
                className="w-full pl-10 pr-4 py-3 border border-[--border] rounded-xl text-sm focus:outline-none focus:border-primary transition-colors bg-bg" />
            </div>
          )}
          ...
          <div className="relative">
            ...
            <input value={form.password} onChange={set('password')} placeholder="Contraseña"
              ...
              className="w-full pl-10 pr-10 py-3 border border-[--border] rounded-xl text-sm focus:outline-none focus:border-primary transition-colors bg-bg" />
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-primary-dark disabled:opacity-50 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-colors shadow-green">
            {isLoading ? (
